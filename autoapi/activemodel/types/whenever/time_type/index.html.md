# activemodel.types.whenever.time_type

## Classes

| [`TimeType`](#activemodel.types.whenever.time_type.TimeType)   | SQLAlchemy TypeDecorator for whenever.Time.   |
|----------------------------------------------------------------|-----------------------------------------------|

## Module Contents

### *class* activemodel.types.whenever.time_type.TimeType(\*args: Any, \*\*kwargs: Any)
