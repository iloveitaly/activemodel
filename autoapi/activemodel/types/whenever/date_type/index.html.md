# activemodel.types.whenever.date_type

## Classes

| [`DateType`](#activemodel.types.whenever.date_type.DateType)   | SQLAlchemy TypeDecorator for whenever.Date.   |
|----------------------------------------------------------------|-----------------------------------------------|

## Module Contents

### *class* activemodel.types.whenever.date_type.DateType(\*args: Any, \*\*kwargs: Any)
