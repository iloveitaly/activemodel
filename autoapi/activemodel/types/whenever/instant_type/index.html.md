# activemodel.types.whenever.instant_type

## Classes

| [`InstantType`](#activemodel.types.whenever.instant_type.InstantType)   | SQLAlchemy TypeDecorator for whenever.Instant.   |
|-------------------------------------------------------------------------|--------------------------------------------------|

## Module Contents

### *class* activemodel.types.whenever.instant_type.InstantType(\*args: Any, \*\*kwargs: Any)
