...
* [activemodel.query_wrapper](query_wrapper/index.md)
* [activemodel.session_manager](session_manager/index.md)
* [activemodel.types](types/index.md)
* [activemodel.utils](utils/index.md)

## Classes

| [`BaseModel`](#activemodel.BaseModel)           | Base model class to inherit from so we can hate python less.   |
|-------------------------------------------------|----------------------------------------------------------------|
| [`SessionManager`](#activemodel.SessionManager) |                                                                |
